...
def saveInitialSteps(abstractAlgorithm):
...
def mergeAlignments(strategyName, overlapLowercase=True):
    ...
    #newAlignmentBool[queryToHmm.shape[0]:, colIndex[1:]] = 0 #
...
def scoreAlignment(strategyName):
    ...
    if strategyName == 'stefan_TrueUPP':
        saveTrueUPPSubset()
    saveTrueAlignFasta()
    ...
    predictionName = "./data/internalData/" + dataFolderName + "/" + strategyName + '/hmmQueryList/merged/query_alignmentFasta.fasta'
