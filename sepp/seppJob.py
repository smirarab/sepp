...
def parseOptions (commandLine = None):
    ...
    group6InfoString = ' '.join(["These options control input. To run SEPP the following is required. A backbone tree (in newick format), a RAxML_info file (this is the file generated by RAxML when a tree is being estimated. This file is required by pplacer.), a backbone alignment file (infasta format), and a fasta file with fragments.  "])
    ...
    group6.add_option("-r", "--raxml", 
                      ...
                      help = "RAxML_info file including model parameters, generated by RAxML (alternatively, a phyml .stat file might work)"
                             "[default: %default]")    
